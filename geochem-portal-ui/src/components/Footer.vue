      ...
      <div class="row">
          ...
          <div class="row feedback__section">
            <div class="col col-sm-6 col-md-6 col-lg-12">
              ...
              <p class="qgds__footer__cta-content">
                Get in touch if you have any enquiries, comments and suggestions on Department of
                Resources services.
              </p>
            </div>
            <div class="col col-sm-6 col-md-6 col-lg-12">
        ...
        <div class="col-xs-12 col-lg-2 qgds__footer__column">
          <nav class="qgds__footer__navigation" aria-label="footer">
            ...
            <ul class="qgds__link-list">
              ...
              <li>
                <a class="qgds__footer__clickable__link" href="https://www.qld.gov.au/languages/"
                  >Other languages</a
                >
              </li>
            </ul>
        ...
        <div class="col-xs-12 col-lg-2 qgds__footer__column">
          <nav class="qgds__footer__social" aria-label="social media links">
            ...
            <ul class="qgds__link-list">
              <li>
                <a class="qgds__footer__clickable__link" href="https://www.facebook.com/MiningQld">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    viewBox="0 0 12 21"
        ...
        <div class="col-xs-12 col-lg-5 qgds__footer__column">
          ...
          <p class="qgds__footer__acknowledgements">
            The Department of Resources acknowledges Aboriginal peoples and Torres Strait Islander
            peoples as the Traditional Owners and custodians of the land, sea and community, and
            recognises their continuing contribution towards creating this strong and prosperous
            state of Queensland. We pay our respects to Elders past, present and emerging, and
            acknowledge those of the stolen generation who are still finding their way home.
          </p>

          <a class="qgds__footer__logo" href="https://www.qld.gov.au/" title="Queensland Government"
